#
#  Be sure to run `pod spec lint TempoStepper.podspec' to ensure this is a
...
Also, you can edit the auto stepping speeds, min/max values of stepper and displaying decimals or not.
  ...
  s.homepage     = "https://github.com/cemolcay/TempoStepper"
  ...
  s.source       = { :git => "https://github.com/cemolcay/TempoStepper.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "TempoStepper/TempoStepper.swift"
